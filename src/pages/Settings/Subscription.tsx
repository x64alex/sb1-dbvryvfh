  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const currentPlanId = data.subscription.category.toLowerCase();
          ...
          <div className="flex items-start justify-between">
            <div>
              <div className="flex items-center">
                ...
                <h2 className="text-xl font-semibold">{subscriptionData.subscription.category} Plan</h2>
              </div>
              <p className="mt-2 text-blue-100">
                Next billing date: {formatDate(subscriptionData.subscription.next_renewal.unixtime)}
              </p>
            </div>
